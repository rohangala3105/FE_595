...
import glob
#The credentials file has two functions getusername() and getpassword() returning username and password repectively
import credentials
...
prefs = { 'download.default_directory': 'C:/Users/Poojan/Documents/SIT_01/Sem03/FE-595/Hw3_files' }
